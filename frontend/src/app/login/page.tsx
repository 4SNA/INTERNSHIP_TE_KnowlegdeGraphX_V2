    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-zinc-950 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md px-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <Card className="bg-zinc-900/40 border-zinc-800/60 backdrop-blur-2xl p-8 rounded-[40px] shadow-2xl space-y-8 glass relative">
           ...
           {/* Error Display */}
           {error && (
             <div className="flex items-center gap-3 p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-400 animate-slide-up">
           ...
           <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                 <label htmlFor="login-email" className="text-[10px] uppercase font-bold text-zinc-500 tracking-widest ml-1">Email Address</label>
                 <Input 
                   id="login-email"
                   type="email" 
              ...
              <div className="space-y-2">
                 <div className="flex items-center justify-between ml-1">
                    <label htmlFor="login-password" className="text-[10px] uppercase font-bold text-zinc-500 tracking-widest">Password</label>
